...
class PendaftaranKetuaResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Pendaftaran  Ketua & Wakil OSIS';

    // 2. Mengubah judul besar di Header halaman dan Breadcrumbs
    protected static ?string $pluralModelLabel = 'Pendaftaran Calon Ketua & Wakil OSIS';

    // 3. Mengubah label saat membuat data baru (misal: "Create Calon Ketua & Wakil OSIS")
    protected static ?string $modelLabel = 'Pendaftaran Calon Ketua & Wakil OSIS';
